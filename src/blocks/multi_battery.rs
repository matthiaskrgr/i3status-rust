...
pub struct MultiBatteryConfig {
    /// Update interval in seconds
    #[serde(default = "MultiBatteryConfig::default_interval", deserialize_with = "deserialize_duration")]
    pub interval: Duration,

    /// The internal power supply device in `/sys/class/power_supply/` to read
    /// from.
    #[serde(default = "MultiBatteryConfig::default_device")]
    pub device: String,

    /// Options for displaying battery information.
    #[serde(default = "MultiBatteryConfig::default_show")]
    pub show: ShowType,
}

impl MultiBatteryConfig {
...
impl ConfigBlock for MultiBattery {
    type Config = MultiBatteryConfig;
